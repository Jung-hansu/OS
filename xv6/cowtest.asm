...
int main(){
  ...
  11:	e8 0d 04 00 00       	call   423 <getNumFreePages>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 14 09 00 00       	push   $0x914
  1f:	6a 01                	push   $0x1
  21:	e8 ba 04 00 00       	call   4e0 <printf>
    test();
  26:	e8 05 00 00 00       	call   30 <test>
    exit();
...
00000030 <test>:
{
  ...
  33:	83 ec 10             	sub    $0x10,%esp
    printf(1, "------------------Test------------------\n");
  36:	68 08 08 00 00       	push   $0x808
  3b:	6a 01                	push   $0x1
  3d:	e8 9e 04 00 00       	call   4e0 <printf>
    if (fork() == 0){
  42:	e8 14 03 00 00       	call   35b <fork>
  47:	83 c4 10             	add    $0x10,%esp
  4a:	85 c0                	test   %eax,%eax
  4c:	74 61                	je     af <test+0x7f>
        printf(1, "P\ta = %d / free pages before changing: %d\n", a, getNumFreePages());
  4e:	e8 d0 03 00 00       	call   423 <getNumFreePages>
  53:	50                   	push   %eax
  54:	ff 35 5c 0c 00 00    	push   0xc5c
  5a:	68 90 08 00 00       	push   $0x890
  5f:	6a 01                	push   $0x1
  61:	e8 7a 04 00 00       	call   4e0 <printf>
        sleep(15);
  66:	c7 04 24 0f 00 00 00 	movl   $0xf,(%esp)
  6d:	e8 81 03 00 00       	call   3f3 <sleep>
        printf(1, "P\ta = %d / free pages after changing a: %d\n",a, getNumFreePages());
  72:	e8 ac 03 00 00       	call   423 <getNumFreePages>
  77:	50                   	push   %eax
  78:	ff 35 5c 0c 00 00    	push   0xc5c
  7e:	68 bc 08 00 00       	push   $0x8bc
  83:	6a 01                	push   $0x1
  85:	e8 56 04 00 00       	call   4e0 <printf>
        wait();
  8a:	83 c4 20             	add    $0x20,%esp
  8d:	e8 d9 02 00 00       	call   36b <wait>
    printf(1, "\nP\ta = %d / free pages after exiting C: %d\n",a, getNumFreePages());
  92:	e8 8c 03 00 00       	call   423 <getNumFreePages>
  97:	50                   	push   %eax
  98:	ff 35 5c 0c 00 00    	push   0xc5c
  9e:	68 e8 08 00 00       	push   $0x8e8
  a3:	6a 01                	push   $0x1
  a5:	e8 36 04 00 00       	call   4e0 <printf>
}
  aa:	83 c4 10             	add    $0x10,%esp
  ad:	c9                   	leave  
  ae:	c3                   	ret    
        printf(1, "C\ta = %d / free pages before changing a: %d\n", a,getNumFreePages());
  af:	e8 6f 03 00 00       	call   423 <getNumFreePages>
  b4:	50                   	push   %eax
  b5:	ff 35 5c 0c 00 00    	push   0xc5c
  bb:	68 34 08 00 00       	push   $0x834
  c0:	6a 01                	push   $0x1
  c2:	e8 19 04 00 00       	call   4e0 <printf>
        printf(1, "\n");
  c7:	58                   	pop    %eax
  c8:	5a                   	pop    %edx
  c9:	68 2f 09 00 00       	push   $0x92f
  ce:	6a 01                	push   $0x1
  d0:	e8 0b 04 00 00       	call   4e0 <printf>
        sleep(10);
  d5:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  dc:	e8 12 03 00 00       	call   3f3 <sleep>
        a = 2;
  e1:	c7 05 5c 0c 00 00 02 	movl   $0x2,0xc5c
  e8:	00 00 00 
        printf(1, "C\ta = %d / free pages after changing a: %d\n", a,getNumFreePages());
  eb:	e8 33 03 00 00       	call   423 <getNumFreePages>
  f0:	50                   	push   %eax
  f1:	ff 35 5c 0c 00 00    	push   0xc5c
  f7:	68 64 08 00 00       	push   $0x864
  fc:	6a 01                	push   $0x1
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 90 09 00 00 	movzbl 0x990(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 38 09 00 00 	jmp    *0x938(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 31 09 00 00       	mov    $0x931,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 60 0c 00 00       	mov    0xc60,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 60 0c 00 00    	mov    %edx,0xc60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 60 0c 00 00    	mov    0xc60,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 60 0c 00 00 64 	movl   $0xc64,0xc60
 7d7:	0c 00 00 
    base.s.size = 0;
 7da:	bf 64 0c 00 00       	mov    $0xc64,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 64 0c 00 00 64 	movl   $0xc64,0xc64
 7e6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 7f2:	00 00 00 
    if(p->s.size >= nunits){
