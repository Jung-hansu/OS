...
_forknexectest:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  11:	c7 45 ec 58 07 00 00 	movl   $0x758,-0x14(%ebp)
	int ret;
	
	printf(1, "Test forknexec syscall\n");
  18:	68 6a 07 00 00       	push   $0x76a
  1d:	6a 01                	push   $0x1
	const char *args[] = {"echo", "NEWPROC_CALL", 0};
  1f:	c7 45 f0 5d 07 00 00 	movl   $0x75d,-0x10(%ebp)
  ...
  3b:	e8 13 03 00 00       	call   353 <forknexec>
	printf(1, "returned: %d\n", ret);
  40:	83 c4 0c             	add    $0xc,%esp
  43:	50                   	push   %eax
  44:	68 82 07 00 00       	push   $0x782
  49:	6a 01                	push   $0x1
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 90 07 00 00       	mov    $0x790,%edx
        while(*s != 0){
