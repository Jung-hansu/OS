...
_starvtest:     file format elf32-i386
...
int main(){
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    starvation_test();
   6:	e8 05 00 00 00       	call   10 <starvation_test>
   b:	31 c0                	xor    %eax,%eax
   d:	c9                   	leave  
   e:	c3                   	ret    
   f:	90                   	nop

00000010 <starvation_test>:
...
void starvation_test(){
  ...
  1a:	68 98 07 00 00       	push   $0x798
  1f:	6a 01                	push   $0x1
  21:	e8 4a 04 00 00       	call   470 <printf>
    sleep(70);
  26:	c7 04 24 46 00 00 00 	movl   $0x46,(%esp)
  2d:	e8 51 03 00 00       	call   383 <sleep>
        pid = fork();
  32:	e8 b4 02 00 00       	call   2eb <fork>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	89 c3                	mov    %eax,%ebx
        if (n > 5) set_proc_priority(getpid(), 3);
  3c:	eb 2b                	jmp    69 <starvation_test+0x59>
  3e:	66 90                	xchg   %ax,%ax
        if(pid == 0)
  40:	74 3e                	je     80 <starvation_test+0x70>
    for(n=0; n<N; n++){
  42:	83 c6 01             	add    $0x1,%esi
  45:	83 fe 32             	cmp    $0x32,%esi
  48:	74 23                	je     6d <starvation_test+0x5d>
        pid = fork();
  4a:	e8 9c 02 00 00       	call   2eb <fork>
  4f:	89 c3                	mov    %eax,%ebx
        if (n > 5) set_proc_priority(getpid(), 3);
  51:	83 fe 05             	cmp    $0x5,%esi
  54:	7e 13                	jle    69 <starvation_test+0x59>
  56:	e8 18 03 00 00       	call   373 <getpid>
  5b:	83 ec 08             	sub    $0x8,%esp
  5e:	6a 03                	push   $0x3
  60:	50                   	push   %eax
  61:	e8 35 03 00 00       	call   39b <set_proc_priority>
  66:	83 c4 10             	add    $0x10,%esp
        if(pid < 0) break;
  69:	85 db                	test   %ebx,%ebx
  6b:	79 d3                	jns    40 <starvation_test+0x30>
}
  6d:	8d 65 f8             	lea    -0x8(%ebp),%esp
  70:	5b                   	pop    %ebx
  71:	5e                   	pop    %esi
  72:	5d                   	pop    %ebp
    wait();
  73:	e9 83 02 00 00       	jmp    2fb <wait>
  78:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  7f:	90                   	nop
                get_proc_cnt(getpid());
  80:	e8 ee 02 00 00       	call   373 <getpid>
  85:	83 ec 0c             	sub    $0xc,%esp
  88:	50                   	push   %eax
  89:	e8 1d 03 00 00       	call   3ab <get_proc_cnt>
                sleep(10);
  8e:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  95:	e8 e9 02 00 00       	call   383 <sleep>
  9a:	83 c4 10             	add    $0x10,%esp
  9d:	eb e1                	jmp    80 <starvation_test+0x70>
  9f:	90                   	nop
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 b0 07 00 00 	jmp    *0x7b0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba a9 07 00 00       	mov    $0x7a9,%edx
        while(*s != 0){
 ...
 611:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 d8 0a 00 00    	mov    %edx,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 782:	00 00 00 
    if(p->s.size >= nunits){
